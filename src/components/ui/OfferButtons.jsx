  ...
  return (
    <>
      <button
        ...
        className="flex items-center w-full max-w-xs mx-auto justify-center gap-3 p-4 bg-gradient-to-br from-brand-500 to-brand-600 text-white rounded-xl hover:shadow-xl transition-all shadow-lg"
      >
