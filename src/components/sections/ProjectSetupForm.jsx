        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <fieldset className="space-y-8">
            <div className="p-6 border rounded-lg">
              <h2 className="text-lg font-semibold text-gray-800 mb-4 flex items-center"><File className="w-5 h-5 mr-2 text-brand-600" />Dane Główne</h2>
            ...
            <div className="p-6 border rounded-lg">
              <h2 className="text-lg font-semibold text-gray-800 mb-4 flex items-center"><User className="w-5 h-5 mr-2 text-brand-600" />Dane Klienta</h2>
            ...
            <div className="p-6 border rounded-lg">
              <h2 className="text-lg font-semibold text-gray-800 mb-4 flex items-center"><Calendar className="w-5 h-5 mr-2 text-brand-600" />Dane Realizacji</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="pt-6 text-right">
              <button type="submit" className="bg-brand-600 text-white font-semibold py-3 px-8 rounded-lg hover:bg-brand-700 transition-colors">
                Zapisz i Kontynuuj
              </button>
            </div>
          </fieldset>
...
const Input = ({ label, name, register, required, errors, type = 'text', placeholder }) => (
    <div>
        ...
        <input
            ...
            className={`w-full p-2 border rounded-md focus:ring-2 focus:ring-brand-500 ${errors[name] ? 'border-red-500' : 'border-gray-300'} disabled:bg-gray-100 disabled:cursor-not-allowed`}
        />
